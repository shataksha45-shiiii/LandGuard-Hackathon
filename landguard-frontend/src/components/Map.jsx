...
// This component now ONLY handles flying the camera to Khapri Khurd
...
const Map = ({ plots, onPlotClick, center }) => {
  // Default coordinates if the system hasn't loaded Khapri Khurd yet
  const defaultCenter = [21.572, 81.846];
            ...
            >
              <Popup className="font-sans text-slate-900">
                <div className="p-1">
                  ...
                  <p className="text-xs text-slate-500">KHAPRI KHURD INDUSTRIAL AREA</p>
                </div>
              </Popup>
            </Polygon>
          );
